...
export const AuthScreen: React.FC<AuthScreenProps> = ({
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-6 select-none w-full relative">
      {/* Centered Modal Card (Matching sc-sign-in.png) */}
      <div className="w-full max-w-xl bg-[#1c1c1f] rounded-2xl border border-[#27272a] p-8 sm:p-10 shadow-2xl flex flex-col space-y-8 relative">
        {onCancel && (
          <button
            type="button"
            onClick={onCancel}
